defmodule TaskTrackerSpaWeb.TaskControllerTest do
  ...
  @create_attrs %{desc: "some desc", done: true, time: 42, title: "some title"}
  @update_attrs %{desc: "some updated desc", done: false, time: 43, title: "some updated title"}
  @invalid_attrs %{desc: nil, done: nil, time: nil, title: nil}
